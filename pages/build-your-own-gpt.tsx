...
// Add the NavLink and Navigation components here (same as in index.tsx)
  ...
  return (
    <div>
      ...
      <div className="prose max-w-none">
        <p className="mb-4">
          If you want to get access to API of any model which is used in here, then contact us at this email:
        </p>
        ...
        <p className="mb-4">
          And yes, as always, it is free also.
        </p>
      </div>
    </div>
  );
